...
public class ItemDTO {
    ...
    public ItemDTO(String itemName, int itemVendorId, int itemModelYear, float itemListPrice) {
    ...
    public String toString() {
        return "Items [itemListPrice=" + itemListPrice + ", itemModelYear=" + itemModelYear
